...
public class BpmsampleTestContainer extends TestContainer {

    public BpmsampleTestContainer() {
        super();
        ...
        appPropertiesFiles = Arrays.asList(
                ...
                "com/company/bpmsample/app.properties",
    ...
    public static class Common extends BpmsampleTestContainer {

        public static final BpmsampleTestContainer.Common INSTANCE = new BpmsampleTestContainer.Common();
